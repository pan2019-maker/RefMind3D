...
UninstallDisplayIcon={app}\RefMind3D-App-1.8.0.ico
...
Root: HKCR; Subkey: "RefMind3D.Project\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\RefMind3D-Project-1.8.0.ico,0"; Flags: uninsdeletekeyifempty
...
[Icons]
Name: "{autoprograms}\RefMind3D"; Filename: "{app}\refmind3d.exe"; IconFilename: "{app}\RefMind3D-App-1.8.0.ico"
Name: "{autodesktop}\RefMind3D"; Filename: "{app}\refmind3d.exe"; IconFilename: "{app}\RefMind3D-App-1.8.0.ico"; Tasks: desktopicon
