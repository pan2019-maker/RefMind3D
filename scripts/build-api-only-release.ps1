...
Copy-Item -LiteralPath $shortcutIcon -Destination (Join-Path $AppStage "RefMind3D-App-1.1.6.ico") -Force
...
Copy-Item -LiteralPath $projectIcon -Destination (Join-Path $AppStage "RefMind3D-Project-1.1.6.ico") -Force
